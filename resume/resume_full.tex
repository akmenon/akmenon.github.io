...
\begin{itemize} \itemsep -4pt
    \item Managing a team of research scientists working on new techniques for large-scale neural retrieval and re-ranking, improved training and inference efficiency of large (language) models
\end{itemize}
}
\WorkEntry
...
{%
\begin{itemize} \itemsep -4pt
    \item Worked on new techniques for large-scale neural retrieval and re-ranking
\end{itemize}
}
