...
\begin{itemize}
    ...
    \item Launched solutions with partners in Gemini (n\'{e}e Bard), Vertex, Search Generative Experience
\end{itemize}
}
...
% %%% ------------------------------------------------------------
\NewPart{Intern (Co-)Supervisor}{}

\WorkEntry
{Licong Lin}
{Spring 2025}
{UC Berkeley}
{Student Researcher at Google Research NYC}
...
{SUTD}
{2025}
{The power of many: model orchestration for efficient LLMs}
{\vspace{-\baselineskip}}
...
{2024}
{A tale of two encoders for neural retrieval}
{\vspace{-\baselineskip}}

\WorkEntry
{ACML WSRL Workshop}
{2020}
{Training deep networks under label noise: new views on old tricks}
{\vspace{-\baselineskip}}
